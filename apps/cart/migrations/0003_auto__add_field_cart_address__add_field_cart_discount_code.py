...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cart.address'
        db.add_column('cart_cart', 'address',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'Cart.discount_code'
        db.add_column('cart_cart', 'discount_code',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Cart.address'
        db.delete_column('cart_cart', 'address')

        # Deleting field 'Cart.discount_code'
        db.delete_column('cart_cart', 'discount_code')
    ...
    models = {
        ...
        'cart.cart': {
            ...
            'discount_code': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
