...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('listings_listing', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='listings', to=orm['auth.User'])),
        ...
        db.create_table('listings_listingimage', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('listing', self.gf('django.db.models.fields.related.ForeignKey')(related_name='images', to=orm['listings.Listing'])),
            ('image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True)),
        ))
        db.send_create_signal('listings', ['ListingImage'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('listings_listingimage')
