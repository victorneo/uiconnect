...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field categories on 'Listing'
        db.create_table('listings_listing_categories', (
        ...
        db.create_unique('listings_listing_categories', ['listing_id', 'category_id'])


    def backwards(self, orm):
        # Removing M2M table for field categories on 'Listing'
        db.delete_table('listings_listing_categories')
