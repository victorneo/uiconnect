...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.alternate_login'
        db.add_column('accounts_userprofile', 'alternate_login',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.alternate_login'
        db.delete_column('accounts_userprofile', 'alternate_login')
