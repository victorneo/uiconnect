...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.default_currency'
        db.add_column('accounts_userprofile', 'default_currency',
                      self.gf('django.db.models.fields.CharField')(default='USD', max_length=3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.default_currency'
        db.delete_column('accounts_userprofile', 'default_currency')
    ...
    models = {
        ...
        'accounts.userprofile': {
            ...
            'default_currency': ('django.db.models.fields.CharField', [], {'default': "'USD'", 'max_length': '3'}),
