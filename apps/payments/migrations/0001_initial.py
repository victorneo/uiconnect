...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('payments_payment', (
            ...
            ('pdt', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['pdt.PayPalPDT'], unique=True)),
        ))
    ...
    models = {
        ...
        'payments.payment': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pdt': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['pdt.PayPalPDT']", 'unique': 'True'}),
