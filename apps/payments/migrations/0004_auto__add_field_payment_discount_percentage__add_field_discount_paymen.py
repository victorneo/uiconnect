...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Payment.discount_percentage'
        db.add_column('payments_payment', 'discount_percentage',
                      self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=3, decimal_places=2),
                      keep_default=False)

        # Adding field 'Discount.payment'
        db.add_column('payments_discount', 'payment',
                      self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='discount', unique=True, null=True, to=orm['payments.Payment']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Payment.discount_percentage'
        db.delete_column('payments_payment', 'discount_percentage')

        # Deleting field 'Discount.payment'
        db.delete_column('payments_discount', 'payment_id')
    ...
    models = {
        ...
        'payments.discount': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'payment': ('django.db.models.fields.related.OneToOneField', [], {'blank': 'True', 'related_name': "'discount'", 'unique': 'True', 'null': 'True', 'to': "orm['payments.Payment']"}),
        ...
        'payments.payment': {
            ...
            'discount_percentage': ('django.db.models.fields.DecimalField', [], {'default': '0.0', 'max_digits': '3', 'decimal_places': '2'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
