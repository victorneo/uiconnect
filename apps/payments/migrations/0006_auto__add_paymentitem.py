...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('payments_paymentitem', (
        ...
        db.send_create_signal('payments', ['PaymentItem'])

        # Removing M2M table for field listings on 'Payment'
        db.delete_table('payments_payment_listings')


    def backwards(self, orm):
        # Deleting model 'PaymentItem'
        db.delete_table('payments_paymentitem')

        # Adding M2M table for field listings on 'Payment'
        db.create_table('payments_payment_listings', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('payment', models.ForeignKey(orm['payments.payment'], null=False)),
            ('listing', models.ForeignKey(orm['listings.listing'], null=False))
        ))
        db.create_unique('payments_payment_listings', ['payment_id', 'listing_id'])
    ...
    models = {
        ...
        'payments.discount': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'payment': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'discount'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': "orm['payments.Payment']", 'blank': 'True', 'unique': 'True'}),
        ...
        'payments.payment': {
            ...
            'listings': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'payments'", 'symmetrical': 'False', 'through': "orm['payments.PaymentItem']", 'to': "orm['listings.Listing']"}),
        ...
        'payments.paymentitem': {
            ...
            'payment': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['payments.Payment']"}),
