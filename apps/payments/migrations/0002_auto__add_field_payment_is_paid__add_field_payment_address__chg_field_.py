...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Payment.address'
        db.add_column('payments_payment', 'address',
        ...
        # Changing field 'Payment.pdt'
        db.alter_column('payments_payment', 'pdt_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['pdt.PayPalPDT'], unique=True, null=True))

    def backwards(self, orm):
        # Deleting field 'Payment.is_paid'
        db.delete_column('payments_payment', 'is_paid')

        # Deleting field 'Payment.address'
        db.delete_column('payments_payment', 'address')

        # Removing M2M table for field listings on 'Payment'
        db.delete_table('payments_payment_listings')


        # User chose to not deal with backwards NULL issues for 'Payment.pdt'
        raise RuntimeError("Cannot reverse this migration. 'Payment.pdt' and its values cannot be restored.")
