...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Discount.payment'
        db.alter_column('payments_discount', 'payment_id', self.gf('django.db.models.fields.related.OneToOneField')(null=True, on_delete=models.SET_NULL, to=orm['payments.Payment'], unique=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Discount.payment'
        db.alter_column('payments_discount', 'payment_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['payments.Payment']))
