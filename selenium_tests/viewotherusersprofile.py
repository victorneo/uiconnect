...
class Viewotherusersprofile(unittest.TestCase):
    ...
    def test_viewotherusersprofile(self):
        ...
        try: self.assertEqual("0 followers.", driver.find_element_by_xpath("//div[@id='container-wrapper']/div/div/div/p[3]/small").text)
        except AssertionError as e: self.verificationErrors.append(str(e))
        driver.find_element_by_id("btn_follow").click()
        try: self.assertEqual("1 follower.", driver.find_element_by_xpath("//div[@id='container-wrapper']/div/div/div/p[3]/small").text)
        except AssertionError as e: self.verificationErrors.append(str(e))
        driver.find_element_by_id("btn_follow").click()
        try: self.assertEqual("0 followers.", driver.find_element_by_xpath("//div[@id='container-wrapper']/div/div/div/p[3]/small").text)
        except AssertionError as e: self.verificationErrors.append(str(e))
