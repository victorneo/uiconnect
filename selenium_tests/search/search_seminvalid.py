...
class SearchSemivalid(unittest.TestCase):
    def setUp(self):
    ...
    def test_search_semivalid(self):
        driver = self.driver
        driver.get(self.base_url + "/")
        driver.find_element_by_link_text("LOGIN").click()
        driver.find_element_by_id("id_username").clear()
        driver.find_element_by_id("id_username").send_keys("bo")
        ...
        driver.find_element_by_name("query").send_keys("cars")
