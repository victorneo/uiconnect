...
class Normal(unittest.TestCase):
    ...
    def test_normal(self):
        ...
        driver.find_element_by_id("id_email").send_keys("andylau@hotmail.com")
        driver.find_element_by_id("id_password").clear()
        driver.find_element_by_id("id_password").send_keys("111")
        driver.find_element_by_id("id_password2").clear()
        driver.find_element_by_id("id_password2").send_keys("111")
        driver.find_element_by_id("id_bio").clear()
        driver.find_element_by_id("id_bio").send_keys("andylau")
