...
class Itemmanage(unittest.TestCase):
    ...
    def test_itemmanage(self):
        ...
        try: self.assertEqual("A Box of HP Books.", driver.find_element_by_id("caption_15").get_attribute("value"))
        except AssertionError as e: self.verificationErrors.append(str(e))
        driver.find_element_by_id("caption_15").clear()
        driver.find_element_by_id("caption_15").send_keys("A Box of HP Adult Cover Books.")
        ...
        try: self.assertEqual("Saved", driver.find_element_by_id("success_15").text)
        except AssertionError as e: self.verificationErrors.append(str(e))
        try: self.assertEqual("A Box of HP Adult Cover Books.", driver.find_element_by_id("caption_15").get_attribute("value"))
        except AssertionError as e: self.verificationErrors.append(str(e))
