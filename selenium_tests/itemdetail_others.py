...
class ItemdetailOthers(unittest.TestCase):
    ...
    def test_itemdetail_others(self):
        ...
        self.assertTrue("0 likes this." in driver.find_element_by_tag_name("body").text)
        driver.find_element_by_id("btn_like").click()
        try: self.assertEqual("Elmo's ABC Book", driver.find_element_by_css_selector("h1").text)
        except AssertionError as e: self.verificationErrors.append(str(e))  
        self.assertTrue("1 likes this." in driver.find_element_by_tag_name("body").text)
        driver.find_element_by_id("btn_like").click()
        try: self.assertEqual("Elmo's ABC Book", driver.find_element_by_css_selector("h1").text)
        except AssertionError as e: self.verificationErrors.append(str(e))  
        self.assertTrue("0 likes this." in driver.find_element_by_tag_name("body").text)
        ...
        self.assertTrue("0 followers" in driver.find_element_by_tag_name("body").text)
        driver.find_element_by_id("btn_follow").click()
        try: self.assertEqual("Elmo's ABC Book", driver.find_element_by_css_selector("h1").text)
        except AssertionError as e: self.verificationErrors.append(str(e))         
        self.assertTrue("1 followers" in driver.find_element_by_tag_name("body").text)
        driver.find_element_by_id("btn_follow").click()
        try: self.assertEqual("Elmo's ABC Book", driver.find_element_by_css_selector("h1").text)
        except AssertionError as e: self.verificationErrors.append(str(e))
        self.assertTrue("0 followers" in driver.find_element_by_tag_name("body").text)        
        ...
        driver.find_element_by_xpath("//input[@value='Add Item to Cart']").click()
        try: self.assertEqual("Elmo's ABC Book", driver.find_element_by_css_selector("h1").text)
        except AssertionError as e: self.verificationErrors.append(str(e)) 
        self.assertTrue("Added to your shopping cart." in driver.find_element_by_tag_name("body").text)
        self.assertTrue("Already in your shopping cart." in driver.find_element_by_tag_name("body").text)
        ...
        self.assertTrue("Removed item from cart." in driver.find_element_by_tag_name("body").text)       
