...
DATABASES = {
    'default': {
        ...
        'NAME': 'uiconnect/db.sqlite',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'd3mp27!wnv4@kvlw$_3tr2m*tg$3#!uz&amp;sry7_jn#9+jw9r0&amp;a'
...
ROOT_URLCONF = 'uiconnect.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'uiconnect.wsgi.application'
...
AUTHENTICATION_BACKENDS = ('django.contrib.auth.backends.ModelBackend', 'accounts.backends.FacebookBackend', 'accounts.backends.PersonaBackend')
